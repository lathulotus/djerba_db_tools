...
CouchDB contains a vast amount of clinical reports. Failed clinical reports (i.e., not reaching quality thresholds) result in non-clinical research reports. RUO reports generated on request are not archived on the database. Briefly, differences in metadata fields are as follows:

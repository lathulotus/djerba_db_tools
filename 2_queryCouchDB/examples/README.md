...
- Note: run_retrieve must be set to true! Setting all values under run_retrieve to  allows for all reports to be downloaded for variant filtering.
```
query_pipeline:
  run_retrieve: true
  run_variant: true
...
- Note: run_retrieve must be set to true! Setting all values under run_retrieve to  allows for all reports to be downloaded for numeric filtering.
```
query_pipeline:
  run_retrieve: true
  run_variant: false

# Untitled array in Clinical - Report Structure Schema Schema

```txt
Clinical.schema.json#/properties/wgts.snv_indel/propterties/results/properties/body/properties/depth
```

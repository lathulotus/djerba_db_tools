# Untitled boolean in Clinical - Report Structure Schema Schema

```txt
Week1Clinical.schema.json#/properties/results/properties/genomic_biomarkers/TMB/properties/Genomic alteration actionable
```
